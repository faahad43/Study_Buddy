...
import image1 from '../assets/bgselect/download1.jpeg';
import image2 from '../assets/bgselect/download2.png';
import image3 from '../assets/bgselect/download3.png';
import image4 from '../assets/bgselect/download4.png';
import image5 from '../assets/bgselect/download5.png';
import image6 from '../assets/bgselect/download6.png';
import image7 from '../assets/bgselect/download7.png';
import image8 from '../assets/bgselect/download8.png';
import image9 from '../assets/bgselect/download9.png';
  ...
  const renderButtons = () => {
    return buttonImages.map((image, index) => (
      <button
        ...
        style={{ width: '80px', height: '60px' }} // Set width with margin
      >
        <img
          src={image}
          alt={`Image ${index + 1}`}
